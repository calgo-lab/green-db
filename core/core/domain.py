...
class LabelIDType(str, Enum):
    ...
    GOTS = "certificate:GLOBAL_ORGANIC_TEXTILE_STANDARD"
    GOTS_ORGANIC = "certificate:GLOBAL_ORGANIC_TEXTILE_STANDARD_ORGANIC"
    GOTS_MWOM = "certificate:GLOBAL_ORGANIC_TEXTILE_STANDARD_ORGANIC"
