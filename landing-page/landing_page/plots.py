...
def fetch_scraped_page_and_product_count_per_merchant_and_country(_green_db: GreenDB) -> dict:
    """
...
def fetch_latest_product_count_per_merchant_and_country(_green_db: GreenDB) -> dict:
    """
    ...
    """
    # Fetch and save DataFrame
    data_frame = _green_db.get_latest_product_count_per_merchant_and_country()
...
def fetch_latest_scraped_page_count_per_merchant_and_country() -> dict:
    """
...
def fetch_latest_product_count_per_category_and_merchant(_green_db: GreenDB) -> dict:
    """
...
def fetch_product_count_with_unknown_sustainability_label(_green_db: GreenDB) -> dict:
    """
...
def fetch_product_count_by_sustainability_label_credibility_overtime(
    _green_db: GreenDB,
) -> pd.DataFrame:
    """
...
def fetch_extended_information(_green_db: GreenDB) -> dict:
    """
...
def fetch_product_count_by_sustainability_label_credibility(_green_db: GreenDB) -> dict:
    """
    ...
    Returns:
        dict: Dictionary containing cached objects to render in streamlit.
    """
    data_frame = _green_db.get_product_count_by_sustainability_label_credibility()
    return {
...
def fetch_leaderboards(_green_db: GreenDB) -> dict:
    """
...
def fetch_product_families(_green_db: GreenDB) -> dict:
    """
...
def fetch_product_count_credible_sustainability_labels_by_category(_green_db: GreenDB) -> dict:
    """
    ...
    return {
        ...
        "plot_product_count_credible_sustainability_labels_fashion": px.bar(
            data_frame_product_count_credible_sustainability_labels_by_category[
                data_frame_product_count_credible_sustainability_labels_by_category.category.isin(
                    fetch_product_families(_green_db)["fashion"]
                )
            ].sort_values(by="product_count"),
            x="product_count",
            y="category",
        ...
        "plot_product_count_credible_sustainability_labels_electronics": px.bar(
            data_frame_product_count_credible_sustainability_labels_by_category[
                data_frame_product_count_credible_sustainability_labels_by_category.category.isin(
                    fetch_product_families(_green_db)["electronics"]
                )
            ].sort_values(by="product_count"),
            x="product_count",
            y="category",
...
def fetch_category_ecological_vs_social_score_by_category(_green_db: GreenDB) -> dict:
    """
