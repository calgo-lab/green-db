...
def render_label(label: str) -> str:
    ...
    seed(11)
    hover = [blend(t, medium(random(), 50), 0.2) for t in idle]
...
def build_default_content(use_cached: bool = True) -> Dict[str, str]:
    if use_cached:
        ...
        return {
            "excerpt": render_excerpt(filter_products(cache.products, 33)),
...
if __name__ == "__main__":
    ...
    content = rebuild_landing_page(use_cached_content=not args.no_cache)
