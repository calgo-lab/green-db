...
_LABEL_MAPPING = {
    ...
    "an independent animal welfare standard": CertificateType.OTHER,
    "an independent organic in conversion standard": CertificateType.OTHER,
    "an independent organic in-conversion standard": CertificateType.OTHER,
    "an independent organic standard": CertificateType.OTHER,
    "an independent recycling standard": CertificateType.OTHER,
    "an independent recycling standard ": CertificateType.OTHER,
    "an independent recycling standard or a recycled fibre": CertificateType.OTHER,
    "an independent standard or licensed fibre": CertificateType.OTHER,
    ...
    "NATIVA™": CertificateType.OTHER,
    "OCS - Organic Blended Content Standard": CertificateType.ORGANIC_CONTENT_STANDARD_BLENDED,
    "OCS Blended (Organic Content Standard)": CertificateType.ORGANIC_CONTENT_STANDARD_BLENDED,
    "OCS - Organic Content Standard": CertificateType.ORGANIC_CONTENT_STANDARD_100,
    "OCS 100 (Organic Content Standard)": CertificateType.ORGANIC_CONTENT_STANDARD_100,
    ...
    "Polylana®": CertificateType.OTHER,
    ...
    "RCS 100 (Recycled Claim Standard)": CertificateType.RECYCLED_CLAIM_STANDARD_100,
    "Recycled Claim Standard (RCS) - Blended": CertificateType.RECYCLED_CLAIM_STANDARD_BLENDED,
    "RCS Blended (Recycled Claim Standard)": CertificateType.RECYCLED_CLAIM_STANDARD_BLENDED,
    "regenagri®": CertificateType.OTHER,
    "Respectueux des animaux": CertificateType.OTHER,
    "Respectueux des forêts": CertificateType.OTHER,
    "Responsible Down Standard (RDS)": CertificateType.RESPONSIBLE_DOWN_STANDARD,
    "Responsible Mohair Standard": CertificateType.OTHER,
    "Responsible Wool Standard (RWS)": CertificateType.RESPONSIBLE_WOOL_STANDARD,
    ...
    "Texloop™": CertificateType.OTHER,
    "Texlop™ (RCOT™)": CertificateType.OTHER,
    "The REEL Cotton Programme": CertificateType.OTHER,
