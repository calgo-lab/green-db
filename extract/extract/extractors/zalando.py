...
_LABEL_MAPPING = {
    "Responsible Wool Standard": Certificates.RESPONSIBLE_WOOL_STANDARD,
    ...
    "Better Cotton Initiative": Certificates.BETTER_COTTON_INITIATIVE,
    ...
    "Fairtrade Certified Cotton": Certificates.FAIRTRADE_COTTON,
    ...
    "OCS - Organic Blended Content Standard": Certificates.ORGANIC_CONTENT_STANDARD_BLENDED,
    "OEKO-TEX® Made in Green": Certificates.MADE_IN_GREEN_OEKO_TEX,
    "Cradle to Cradle Certified™ Bronze": Certificates.CRADLE_TO_CRADLE_BRONZE,
    "Cradle to Cradle Certified™ Gold": Certificates.CRADLE_TO_CRADLE_GOLD,
    "Cradle to Cradle Certified™ Silver": Certificates.CRADLE_TO_CRADLE_SILVER,
    "Cradle to Cradle Certified™ Platinum": Certificates.CRADLE_TO_CRADLE_PLATINUM,
    "Waldschonend": Certificates.OTHER,
    "Hergestellt aus recyceltem Nylon": Certificates.OTHER,
    "Leather Working Group": Certificates.LEATHER_WORKING_GROUP,
    ...
    "OCS - Organic Content Standard": Certificates.ORGANIC_CONTENT_STANDARD_100,
