...
def male() -> List[dict]:
    path_2_category = {
        ...
        "/bags-accessories-mens-bags/": ProductCategory.BAG.value,
...
def female() -> List[dict]:
    path_2_category = {
        ...
        "/womens-sports-bags-rucksacks/": (ProductCategory.BAG.value, {"type": "SPORT"}),
        ...
        "/bags-accessories-womens-bags/": ProductCategory.BAG.value,
