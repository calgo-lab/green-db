...
def male() -> List[dict]:
    path_2_category = {
        ...
        "/mens-sports-shorts/": (ProductCategory.SHORTS.value, {"type": "SPORT"}),
        "/mens-sports-cropped-trousers/": (ProductCategory.PANTS.value, {"type": "SPORT"}),
        "/mens-sports-trousers/": (ProductCategory.PANTS.value, {"type": "SPORT"}),
        "/mens-running-tights/": (ProductCategory.PANTS.value, {"type": "SPORT"}),
        "/sports-ski-snowboard-trousers-mens/": (ProductCategory.PANTS.value, {"type": "SPORT"}),
        "/mens-sports-sweatshirts/": (ProductCategory.SWEATER.value, {"type": "SPORT"}),
        "/mens-sports-hoodies/": (ProductCategory.SWEATER.value, {"type": "SPORT"}),
        "/mens-sports-fleece-jumpers/": (ProductCategory.SWEATER.value, {"type": "SPORT"}),
        "/mens-sports-sweat-jackets/": (ProductCategory.JACKET.value, {"type": "SPORT"}),
...
def female() -> List[dict]:
    path_2_category = {
        ...
        "/womens-sports-shorts/": (ProductCategory.SHORTS.value, {"type": "SPORT"}),
        "/womens-sports-cropped-trousers/": (ProductCategory.PANTS.value, {"type": "SPORT"}),
        "/womens-sports-trousers/": (ProductCategory.PANTS.value, {"type": "SPORT"}),
        "/womens-running-tights/": (ProductCategory.PANTS.value, {"type": "SPORT"}),
        "/sports-ski-snowboard-trousers-women/": (ProductCategory.PANTS.value, {"type": "SPORT"}),
        "/womens-sports-sweatshirts/": (ProductCategory.SWEATER.value, {"type": "SPORT"}),
        "/womens-sports-hoodies/": (ProductCategory.SWEATER.value, {"type": "SPORT"}),
        "/womens-sports-fleece-jumpers/": (ProductCategory.SWEATER.value, {"type": "SPORT"}),
        "/womens-sports-sweat-jackets/": (ProductCategory.JACKET.value, {"type": "SPORT"}),
