...
def male() -> List[dict]:
    path_2_category = {
        ...
        "/sporthosen-herren-kurz/": (ProductCategory.SHORTS.value, {"type": "SPORT"}),
        "/sporthosen-herren-dreiviertel/": (ProductCategory.PANTS.value, {"type": "SPORT"}),
        "/sporthosen-herren-lang/": (ProductCategory.PANTS.value, {"type": "SPORT"}),
        "/sports-tights-herren/": (ProductCategory.PANTS.value, {"type": "SPORT"}),
        "/ski-snowboardhosen-herren/": (ProductCategory.PANTS.value, {"type": "SPORT"}),
        "/sports-herren-pullover/": (ProductCategory.SWEATER.value, {"type": "SPORT"}),
        "/sports-kapuzenpullover-herren/": (ProductCategory.SWEATER.value, {"type": "SPORT"}),
        "/sports-fleece-pullover-herren/": (ProductCategory.SWEATER.value, {"type": "SPORT"}),
        "/sports-sweatjacke-herren/": (ProductCategory.JACKET.value, {"type": "SPORT"}),
...
def female() -> List[dict]:
    path_2_category = {
        ...
        "/sporthosen-damen-kurz/": (ProductCategory.SHORTS.value, {"type": "SPORT"}),
        "/sporthosen-damen-dreiviertel/": (ProductCategory.PANTS.value, {"type": "SPORT"}),
        "/sporthosen-damen-lang/": (ProductCategory.PANTS.value, {"type": "SPORT"}),
        "/sports-tights-damen/": (ProductCategory.PANTS.value, {"type": "SPORT"}),
        "/ski-snowboardhosen-damen/": (ProductCategory.PANTS.value, {"type": "SPORT"}),
        "/sports-damen-pullover/": (ProductCategory.SWEATER.value, {"type": "SPORT"}),
        "/sports-kapuzenpullover-damen/": (ProductCategory.SWEATER.value, {"type": "SPORT"}),
        "/sports-fleece-pullover-damen/": (ProductCategory.SWEATER.value, {"type": "SPORT"}),
        "/sports-sweatjacke-damen/": (ProductCategory.JACKET.value, {"type": "SPORT"}),
