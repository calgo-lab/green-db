...
def male() -> List[dict]:
    path_2_category = {
        ...
        "/herrenbekleidung-pullover-strickjacken/": ProductCategory.SWEATER.value,
        ...
        "/herrenbekleidung-bademaentel/": ProductCategory.UNDERWEAR.value,
        ...
        "/tennisschuhe-herren/": (ProductCategory.SNEAKERS.value, {"type": "SPORT"}),
        "/golfschuhe-herren/": (ProductCategory.SNEAKERS.value, {"type": "SPORT"}),
        "/hallenschuhe-herren/": (ProductCategory.SNEAKERS.value, {"type": "SPORT"}),
        "/fahrradschuhe-herren/": (ProductCategory.SNEAKERS.value, {"type": "SPORT"}),
        "/badeschuhe-herren/": (ProductCategory.SNEAKERS.value, {"type": "SPORT"}),
        "/stiefel-boots-herren/": (ProductCategory.SHOES.value, {"type": "SPORT"}),
        "/sports-taschen-rucksaecke-herren/": (ProductCategory.BAG.value, {"type": "SPORT"}),
...
def female() -> List[dict]:
    path_2_category = {
        ...
        "/damenbekleidung-pullover-und-strickjacken/": ProductCategory.SWEATER.value,
        ...
        "/sports-top-damen/": (ProductCategory.SHIRT.value, {"type": "SPORT"}),
        "/sports-langarmshirts-damen/": (ProductCategory.TSHIRT.value, {"type": "SPORT"}),
        "/sports-blusen-damen/": (ProductCategory.SHIRT.value, {"type": "SPORT"}),
        ...
        "/sports-damen-struempfe/": (ProductCategory.UNDERWEAR.value, {"type": "SPORT"}),
        ...
        "/laufschuhe-damen/": (ProductCategory.SNEAKERS.value, {"type": "SPORT"}),
        "/sports-outdoorschuhe-damen/": (ProductCategory.SNEAKERS.value, {"type": "SPORT"}),
        "/tennisschuhe-damen/": (ProductCategory.SNEAKERS.value, {"type": "SPORT"}),
        "/golfschuhe-damen/": (ProductCategory.SNEAKERS.value, {"type": "SPORT"}),
        "/hallenschuhe-damen/": (ProductCategory.SNEAKERS.value, {"type": "SPORT"}),
        "/hallenschuhe-trainingsschuhe-damen/": (ProductCategory.SNEAKERS.value, {"type": "SPORT"}),
        "/badeschuhe-damen/": (ProductCategory.SNEAKERS.value, {"type": "SPORT"}),
        "/damen-fussballschuhe/": (ProductCategory.SNEAKERS.value, {"type": "SPORT"}),
        "/stiefel-boots-damen/": (ProductCategory.SNEAKERS.value, {"type": "SPORT"}),
        "/skischuhe-damen/": (ProductCategory.SHOES.value, {"type": "SPORT"}),
        "/fahrradschuhe-damen/": (ProductCategory.SNEAKERS.value, {"type": "SPORT"}),
        "/sports-taschen-rucksaecke-damen/": (ProductCategory.BAG.value, {"type": "SPORT"}),
